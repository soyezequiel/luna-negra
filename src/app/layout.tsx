  ...
  return (
    ...
    >
      <body className="relative flex min-h-full flex-col font-sans text-ln-text">
        {/* El fondo de la página es la textura tileable de animalitos (ver
            globals.css). La escena animada de selva vive sólo en el hero del
            Home (ver app/page.tsx). El chrome va en z-10+ sobre el velo (z-0). */}
